...
public class ClientSetup {
    ...
    @SubscribeEvent
    public void addTexture(TextureStitchEvent.Pre event) {
        if (ModList.get().isLoaded("create")) {
            event.addSprite(new ResourceLocation("create", "fluid/milk_still"));
            event.addSprite(new ResourceLocation("create", "fluid/milk_flow"));
        }
    }
